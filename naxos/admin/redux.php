			...
			$this->sections[] = array(
				...
				'fields'    => array(
					...
					array(
						...
						'type'      => 'select',
						'compiler'  => false,
						'title'     => esc_html__( 'Column Width', 'naxos' ),
						'subtitle'  => esc_html__( 'Column size for each footer widget', 'naxos' ),
						'options'   => array(
							"1/6" 		=> esc_html__( '2 Columns - 1/6', 'naxos' ),
							"1/4" 		=> esc_html__( '3 Columns - 1/4', 'naxos' ),
							"1/3" 		=> esc_html__( '4 Columns - 1/3', 'naxos' ),
							"1/2" 		=> esc_html__( '6 Columns - 1/2', 'naxos' ),
						),
						'default'   => '1/4'
					),
					array(
			...
			$this->sections[] = array(
				...
				'fields'    => array(
					...
					array(
						...
						'type'      => 'text',
						'title'     => esc_html__( 'MailChimp Audience ID', 'naxos' ),
						'default'   => ''
					),
				),
			);
