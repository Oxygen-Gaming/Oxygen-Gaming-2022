...
?>
	...
	<div data-header-section="video" <?php echo esc_attr( $header_section != 'video' ? 'class="meta-hidden"' : '' ); ?>>
		<p><strong><?php esc_html_e( 'Background Video URL', 'naxos' ); ?></strong></p>
		<input type="text" class="meta-item-l" name="video-url" value="<?php echo esc_attr( get_post_meta( $post->ID, 'video-url', true ) ); ?>">
		<p><?php esc_html_e( 'Example', 'naxos' ); ?>, https://youtu.be/mqEeWiRwv0k</p>
	</div>
