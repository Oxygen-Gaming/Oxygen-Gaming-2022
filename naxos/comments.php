		...
		<div class="row">
			<div class="col-12 col-lg-12">
				<div class="form-group mt-2">
					<textarea id="comment" name="comment" class="form-control field-comment mb-3" rows="4" placeholder="' . esc_attr__( 'Comment', 'naxos' ) . '"></textarea>
				</div>
			</div>
		</div>',
	'fields' => array(
		'author' => '
			<div class="row">
				<div class="col-12 col-lg-6">
					<div class="form-group mt-2">
						<input type="text" id="author" name="author" class="form-control field-author mb-3" placeholder="' . esc_attr__( 'Name', 'naxos' ) . '" value="' . esc_attr( $commenter['comment_author'] ) . '"' . $required . '>
					</div>
				</div>',
		'email' => '
				<div class="col-12 col-lg-6">
					<div class="form-group mt-2">
						<input type="email" id="email" name="email" class="form-control field-email mb-3" placeholder="' . esc_attr__( 'Email', 'naxos' ) . '" value="' . esc_attr(  $commenter['comment_author_email'] ) . '"' . $required . '>
					</div>
				</div>
			</div>'
	),
