	...
	public static function naxos_inline_scripts( $page_id ) {
		...
		if ( isset($color_schema) && ! empty($color_schema) ) {
			if ( $color_schema == 'default' ) {
				$color_schema = $naxos_config['styling-schema'];
			}
			
			$mapMarker = get_template_directory_uri( ) . '/assets/images/map-marker-' . $color_schema . '.png';
			
			switch ($color_schema) {
				case 'blue': 		$mapColor = '#7c4fe0'; break;
				case 'green': 		$mapColor = '#2aa275'; break;
				case 'red': 		$mapColor = '#ff3d65'; break;
				case 'turquoise': 	$mapColor = '#46cad7'; break;
				case 'purple': 		$mapColor = '#d1397c'; break;	
				case 'orange': 		$mapColor = '#ee8f67'; break;
				case 'yellow': 		$mapColor = '#ffbe00'; break;
				case 'grey': 		$mapColor = '#656d78'; break;
			}
		}
