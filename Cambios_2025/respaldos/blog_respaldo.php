...
<?php
// Blog posts ([blog])
// Este es el respaldo de blog.php por si hicera falta restaurarlo
    ...
    public static function blog( $atts, $content = null ) {
		...
		if ( $query->have_posts( ) ) {
			while ( $query->have_posts( ) ) {
				...
				$post_content = apply_filters( 'the_content', get_the_content( esc_html__( 'Leer más', 'naxos-addons' ) ) );
